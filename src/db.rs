...
impl JiraDatabase {
    ...
    pub fn create_story(&self, story: Story, epic_id: u32) -> Result<u32> {
        ...
        parsed.epics.get_mut(&epic_id).ok_or_else(|| anyhow!("could not find epic in this db"))?.stories.push(new_id);
    ...
    pub fn delete_story(&self,epic_id: u32, story_id: u32) -> Result<()> {
        ...
        let story_idx = epic.stories.iter().position(|id| id == &story_id).ok_or_else(|| anyhow!("story id not found in epic stories vector"))?;
